...
source_dir = r"C:\ai8x-framework\ai8x-training\data\mask_hairnet128"
output_dir = r"C:\ai8x-framework\ai8x-training\data\mask_hairnet96"
    ...
    for file in files:
        if file.lower().endswith(('.png', '.jpg', '.jpeg', '.bmp')):
            try:
                ...
                # Resize to 96x96 using high-quality resampling
                resized_img = img.resize((96, 96), Image.LANCZOS)
