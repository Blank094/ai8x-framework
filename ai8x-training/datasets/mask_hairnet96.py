"""
MASK Hairnet Detection Dataset for 96x96 images
"""
import os
import sys
...
class MaskHairnet96Dataset(Dataset):
    """
...
def get_mask_hairnet96_dataset(data, load_train, load_test):
    """
    ...
    if load_train:
        try:
            train_dataset = MaskHairnet96Dataset(root_dir=data_dir, d_type='train',
    ...
    if load_test:
        try:
            test_dataset = MaskHairnet96Dataset(root_dir=data_dir, d_type='test', transform=transform)
...
datasets = [
    {
        ...
        'loader': get_mask_hairnet96_dataset,
    },
]
