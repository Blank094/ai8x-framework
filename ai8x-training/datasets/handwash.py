...
def get_handwash_dataset(data, load_train, load_test):
    """
    ...
    if load_train:
        try:
            train_dataset = HandwashDataset(root_dir=data_dir, d_type='train',
    ...
    if load_test:
        try:
            test_dataset = HandwashDataset(root_dir=data_dir, d_type='test', transform=transform)
