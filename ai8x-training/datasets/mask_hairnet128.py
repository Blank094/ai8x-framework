"""
MASK Hairnet Detection Dataset for 128x128 images
"""
import os
import sys
...
class MaskHairnet128Dataset(Dataset):
    """
...
def get_mask_hairnet128_dataset(data, load_train, load_test):
    """
    ...
    if load_train:
        try:
            train_dataset = MaskHairnet128Dataset(root_dir=data_dir, d_type='train',
    ...
    if load_test:
        try:
            test_dataset = MaskHairnet128Dataset(root_dir=data_dir, d_type='test', transform=transform)
