"""
Handwash Detection Dataset for 64x64 images
"""
import os
import sys
...
class Handwash64Dataset(Dataset):
    """
...
def get_handwash64_dataset(data, load_train, load_test):
    """
    ...
    if load_train:
        try:
            train_dataset = Handwash64Dataset(root_dir=data_dir, d_type='train',
    ...
    if load_test:
        try:
            test_dataset = Handwash64Dataset(root_dir=data_dir, d_type='test', transform=transform)
