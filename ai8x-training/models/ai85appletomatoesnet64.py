...
###################################################################################################
"""
Apple-Tomatoes Detection Network for AI85 - Optimized for 64x64 input
"""
...
class AI85AppleTomatoesNet64(nn.Module):
    """
    Define CNN model for apple-tomatoes detection (2 classes).
...
def ai85appletomatoesnet64(pretrained=False, **kwargs):
    """
    Constructs a AI85AppleTomatoesNet64 model.
    """
    assert not pretrained
    return AI85AppleTomatoesNet64(**kwargs)


models = [
    {
        'name': 'ai85appletomatoesnet64',
        'min_input': 1,
        'dim': 2,
        'model': AI85AppleTomatoesNet64, # Added model class reference for clarity
    },
]