...
###################################################################################################
"""
MASK Hairnet Detection Network for AI85 - Optimized for 128x128 input
"""
...
class AI85MaskHairnetNet128(nn.Module):
    """
    Define CNN model for MASK Hairnet detection (4 classes).
    Optimized architecture for 128x128 input images.
    """
    def __init__(self, num_classes=4, num_channels=3, dimensions=(128, 128),
...
def ai85maskhairnetnet128(pretrained=False, **kwargs):
    """
    Constructs a AI85MaskHairnetNet128 model.
    """
    assert not pretrained
    return AI85MaskHairnetNet128(**kwargs)


models = [
    {
        'name': 'ai85maskhairnetnet128',
        'min_input': 1,
        'dim': 2,
    },
] 