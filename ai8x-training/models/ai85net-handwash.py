...
###################################################################################################
"""
Handwash Detection Network for AI85 - Optimized for 128x128 input
"""
...
class AI85HandwashNet(nn.Module):
    """
...
def ai85handwashnet(pretrained=False, **kwargs):
    """
    Constructs a AI85HandwashNet model.
    """
    assert not pretrained
    return AI85HandwashNet(**kwargs)


models = [
    {
        'name': 'ai85handwashnet',
        'min_input': 1,
        'dim': 2,
    },
] 