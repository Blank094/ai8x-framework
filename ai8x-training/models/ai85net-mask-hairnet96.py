...
###################################################################################################
"""
MASK Hairnet Detection Network for AI85 - Optimized for 96x96 input
"""
...
class AI85MaskHairnetNet96(nn.Module):
    """
    Define CNN model for MASK Hairnet detection (4 classes).
    Optimized architecture for 96x96 input images.
    """
    def __init__(self, num_classes=4, num_channels=3, dimensions=(96, 96),
...
def ai85maskhairnetnet96(pretrained=False, **kwargs):
    """
    Constructs a AI85MaskHairnetNet96 model.
    """
    assert not pretrained
    return AI85MaskHairnetNet96(**kwargs)


models = [
    {
        'name': 'ai85maskhairnetnet96',
        'min_input': 1,
        'dim': 2,
    },
]
