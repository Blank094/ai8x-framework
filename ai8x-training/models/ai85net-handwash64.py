...
###################################################################################################
"""
Handwash Detection Network for AI85 - Optimized for 64x64 input
"""
...
class AI85HandwashNet64(nn.Module):
    """
    Define CNN model for handwash detection (6 classes).
    Optimized architecture for 64x64 input images.
    """
    def __init__(self, num_classes=6, num_channels=3, dimensions=(64, 64),
...
def ai85handwashnet64(pretrained=False, **kwargs):
    """
    Constructs a AI85HandwashNet64 model.
    """
    assert not pretrained
    return AI85HandwashNet64(**kwargs)


models = [
    {
        'name': 'ai85handwashnet64',
        'min_input': 1,
        'dim': 2,
    },
] 