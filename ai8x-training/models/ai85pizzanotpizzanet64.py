...
###################################################################################################
"""
Pizza-Not-Pizza Classification Network for AI85 - Optimized for 64x64 input
(Modified for better accuracy with Batch Normalization)
"""
...
class AI85PizzaNotPizzaNet64(nn.Module):
    """
    Define CNN model for pizza-not-pizza classification (2 classes).
    Optimized architecture for 64x64 input images.
    Now includes BatchNorm for improved training.
    """
...
def ai85pizzanotpizzanet64(pretrained=False, **kwargs):
    """
    Constructs a AI85PizzaNotPizzaNet64 model.
    """
    assert not pretrained
    return AI85PizzaNotPizzaNet64(**kwargs)


models = [
    {
        'name': 'ai85pizzanotpizzanet64',
        'min_input': 1,
        'dim': 2,
        'model': AI85PizzaNotPizzaNet64, # Added model class reference for clarity
    },
]