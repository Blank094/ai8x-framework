...
###################################################################################################
"""
MASK Hairnet Detection Network for AI85 - Optimized for 64x64 input
"""
...
class AI85MaskHairnetNet64(nn.Module):
    """
    Define CNN model for MASK Hairnet detection (4 classes).
    Optimized architecture for 64x64 input images.
    """
    def __init__(self, num_classes=4, num_channels=3, dimensions=(64, 64),
...
def ai85maskhairnetnet64(pretrained=False, **kwargs):
    """
    Constructs a AI85MaskHairnetNet64 model.
    """
    assert not pretrained
    return AI85MaskHairnetNet64(**kwargs)


models = [
    {
        'name': 'ai85maskhairnetnet64',
        'min_input': 1,
        'dim': 2,
    },
] 